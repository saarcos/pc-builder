    ...
    return (
      <div className="h-screen flex items-center justify-center bg-black text-white">
        <div className="flex flex-col items-center gap-4" ref={loaderRef}>
          <Cog className="w-24 h-24 animate-spin text-pink-500 drop-shadow-[0_0_15px_#ff4b91]" />
          <p className="text-xl font-bold animate-pulse text-pink-400 text-center">Cargando componentes...</p>
        </div>
      </div>
    );
  }
